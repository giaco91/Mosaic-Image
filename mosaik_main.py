...
im=create_pixel_image(path_macro_image=opt.path_to_macro_img,path_micro_images=opt.path_to_image_folder,macro_size=[opt.macro_width,opt.macro_height],micro_size=opt.micro_size,load=opt.load_preprocessed_img,temp=opt.temperature,ratio=opt.amount_of_augmentation)
