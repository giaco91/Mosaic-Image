...
def user_input():
    ...
    if object_check['config_file'] != '':
        ...
        parser.add_argument('-cd', '--chromedriver', help='specify the path to chromedriver executable in your local machine', type=str, required=False, default='/usr/local/bin/chromedriver')
    ...
    def download_extended_page(self,url,chromedriver):
        ...
        try:
           ...
           #browser = webdriver.Chrome(chromedriver) 
            ...
            print("Looks like we cannot locate the path the 'chromedriver' (default path: /usr/local/bin/chromedriver). Use the '--chromedriver' "
